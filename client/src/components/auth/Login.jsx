  ...
  return (
    <>
      <div className='w-full flex flex-col items-center justify-center'>
        <div className='pt-20 pb-5 px-96'>
          <span className='text-black text-3xl font-semibold'>Welcome </span>
          <span className='text-emerald-400 text-3xl font-semibold'>Back!</span>
        </div>

        <div className='pt-6'>
          <div className='pt-3'>
            <div className='text-zinc-900 text-1xl font-semibold'>Email</div>
            <input
              type='text'
              name='email'
              value={email}
              className=' bg-white w-[100%] rounded border border-zinc-500 h-12'
              placeholder='Enter your email'
              onChange={(e) => setEmail(e.target.value)}
            />
          </div>
          <div className='pt-3'>
            <div className='text-zinc-900 text-1xl font-semibold'>
              Set Password
            </div>
            <input
              type='text'
          ...
          <div className='pt-2'>
            ...
            <span className='text-emerald-400 text-1xl font-semibold hover:cursor-pointer'>
              Reset now.
            </span>
          </div>
          <div className='mt-5 w-max flex gap-5'>
            <button
              type='button'
              className=' bg-white rounded-sm border border-emerald-400 w-32 hover:cursor-pointer'
              onClick={() => handleCancle()}
            >
              <div className='text-emerald-400 m-2 text-2xl font-normal'>
                Cancel
              </div>
            </button>
            <button
              type='button'
              className=' bg-emerald-400 rounded-sm w-32 hover:cursor-pointer'
              onClick={() => handleLogin()}
            >
              <div className='text-white text-2xl m-2 font-semibold'>
                Log in
              </div>
            </button>
          </div>
          ...
          <div className='pt-3 '>
            ...
            <span className='text-emerald-400 text-2xl font-semibold hover:cursor-pointer'>
