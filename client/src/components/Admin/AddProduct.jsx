...
const AddProduct = () => {
  const [formData, setFormData] = useState({
    ...
    price: "",
    description: "",
    category: "fruit", // Default category value
    qty: "",
    image1: null,
  });
        ...
        <div className=" bg-white w-[95%] h-[123vh] rounded-2xl shadow m-8">
          ...
          <div className="p-8 pl-10">
            ...
            <div className="my-7 flex">
              ...
              <div className="bg-zinc-200 p-2 pl-4 ml-4 rounded-lg text-xl  outline-none">
                <select
                  value={formData.category}
                  onChange={handleCategoryChange}
                  className="justify-center bg-zinc-200 items-center gap-px flex md:w-32 outline-none"
                >
